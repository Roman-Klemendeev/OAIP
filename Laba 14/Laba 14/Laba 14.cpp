// Laba 14.cpp : Определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
    {
        ...
        if (type == 1) Image1(hdc, image1_x, image1_y, RGB(255, 255, 0));
        if (type == 2) Image2(hdc, image1_x, image1_y);
        if (type == 3) Image3(hdc, image1_x, image1_y);
        if (type == 4) Image4(hdc, image1_x, image1_y);
